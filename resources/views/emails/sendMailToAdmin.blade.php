                                                                ...
                                                                <tr>
                                                                    <td valign="top" style="padding:48px 48px 32px">
                                                                        <div id="m_584358752881652500body_content_inner"
                                                                            ...
                                                                            <p style="margin:0 0 16px">You just recieved
                                                                                the order from
                                                                                {{ $name }}. Orders are as follows:
                                                                            </p>
                                                                                    ...
                                                                                    <tbody>
                                                                                        @foreach ($cart as $item)
                                                                                            <tr>
                                                                                                ...
                                                                                                <td
                                                                                                    style="color:#636363;border:1px solid #e5e5e5;padding:12px;text-align:left;vertical-align:middle;font-family:'Helvetica Neue',Helvetica,Roboto,Arial,sans-serif">
                                                                                                    <span>{{ number_format($item->price, '0', ',', '.') }}<span>$</span></span>
                                                                                                </td>
                                                                                            </tr>
                                                                                        @endforeach
                                                                                    ...
                                                                                    <tfoot>
                                                                                        ...
                                                                                        @if (isset($bill_promo))
                                                                                            <tr>
                                                                                                ...
                                                                                                <td
                                                                                                    style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                                                                                                    -<span>{{ number_format($bill_promo, '0', ',', '.') }}<span>$</span></span>
                                                                                                </td>
                                                                                            </tr>
                                                                                        @endif
                                                                                        <tr>
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td
                                                                                                style="color:#636363;border:1px solid #e5e5e5;vertical-align:middle;padding:12px;text-align:left">
                                                                                                <span>{{ number_format($total, '0', ',', '.') }}<span>$</span> (Shipping fee not included)</span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tfoot>
                                                                                </table>
