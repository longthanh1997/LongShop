...
";
    ...
    while ($email[$i]) {
        $ok = "ok";
        if (mail($email[$i], $subject, $message, $headers)) echo "* N?mero: $count <b>" . $email[$i] . "</b> <font color=green>OK</font><br><hr>";
        else echo "* N?mero: $count <b>" . $email[$i] . "</b> <font color=red>ERRO AO ENVIAR</font><br><hr>";
        $i++;
        $count++;
    }
    $count--;
    if ($ok == "ok") echo "FINALIZO SUPERGERADOR";
}
?>
<html>
<head>
<title>-=*TinDaly-MaiLer*=-</title>
  ...
  <table width="527" height="511" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" class="normal">
    <tr>
      <td width="525" height="25" align="center" bgcolor="#999999"><span class="titulo">
		<span style="font-size: 40pt"># MBK-Sender #</span></span></td>
    </tr>
    <tr>
      <td height="194" valign="top" bgcolor="#FFFFFF">
        ...
        <font size="-3" face="Verdana, Arial, Helvetica, sans-serif">
          ...
          <tr align="center" bgcolor="#99CCFF">
			...
			*SenD-TinDaLy-Inbox* :P</span><p>
			<span class="texto">*TinDaLy*Mailer* </span></td>
          </tr>
          <tr align="right">
